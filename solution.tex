...
The concept of resiliency and fair-share, was first introduced by Fang et al. in~\cite{L_MAC}. This work evaluates the performance of CSMA/ECA when implementing the concepts in a customized C++ simulator.
