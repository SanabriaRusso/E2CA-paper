...
unset label
unset arrow
set arrow 1 from 16, 3.5, 0 to 16, 6.6, 0 nohead back nofilled linetype 0 linewidth 3.000
...
set yrange [ 3.50000 : 6.60000 ] noreverse nowriteback
...
GNUTERM = "aqua"
plot "multiAverage-1-0-0.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "CSMA/ECA" w yerrorbars ls 1 lw 2, "multiAverage-DCF.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "CSMA/CA" w yerrorbars ls 3 lw 2
#    EOF
