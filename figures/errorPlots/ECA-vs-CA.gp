...
unset label
unset arrow
set arrow 1 from 16, 2.9, 0 to 16, 6.3, 0 nohead back nofilled linetype 0 linewidth 3.000
...
set y2tics 1.00000,1,1.00000 norangelimit
...
set xrange [ 1.00000 : 51.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Throughput (Mbps)" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "Jain's Fairness Index (JFI)" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 2.90000 : 6.30000 ] noreverse nowriteback
set y2range [ 0.800000 : 1.50000 ] noreverse nowriteback
set zlabel "" 
...
GNUTERM = "aqua"
plot "multiAverage-1-0-0.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "Basic CSMA/ECA" w yerrorbars ls 1 lw 2, "" u 1:4 title "JFI for Basic CSMA/ECA" w l ls 9 lw 2 axis x1y2, "multiAverage-DCF.txt" u 1:($2/1e6):(1.96*($3/1e6)/3.16) title "CSMA/CA" w yerrorbars ls 3 lw 2, "" u 1:4 title "JFI for CSMA/CA" w l ls 8 lw 2 axis x1y2
#    EOF
